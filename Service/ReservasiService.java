...
public class ReservasiService implements iReservasi{
    ...
    public void tambahDineIn(){
        ...
        int jumlahOrang = Integer.parseInt(inputAngka(""));
        ...
        daftarReservasi.add(new DineIn(nama, waktu, meja, preOrder, menu, totalHarga, jumlahOrang));
        System.out.println("Reservasi Dine-In berhasil ditambahkan!");
    }
    
    public void tambahTakeAway(){
        System.out.print("Nama Pemesan: ");
        String nama = input.nextLine();
        System.out.print("Waktu Pengambilan: ");
        String waktu = input.nextLine();
        ...
        daftarReservasi.add(new TakeAway(nama, waktu, preOrder, menu, totalHarga, false));
